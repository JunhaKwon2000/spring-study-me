			...
			<div id="content">
                ...
                <div class="container-fluid">
					...
					<form method="post">
						...
						<input type="text" class="form-control" id="writer" name="boardWriter" value="${ notice.boardWriter }">
						</div>
						<div class="mb-4">
						<label for="content">Comments</label>
						<textarea class="form-control" placeholder="Write your content here!" id="content" style="height: 100px" name="boardContent">${ notice.boardContent }</textarea>
						</div>
